...
def get_protocol_data(module_code: str, id_destination: int):
    ...
    for name in ["site", "visit"]:
        protocol_data[name]["generic"].extend(
            [
                {
                    "name_field": f"id_base_{name}",
                    "fr_label": f"ID {name}",
                    "type_field": "text",
                    "type_column": "integer",
                    "mandatory": True,
                    "autogenerated": True,
                    "display": False,
                    "source_field": f"src_id_base_{name}",
                    "dest_field": f"id_base_{name}",
                    "multi": False,
                    "id_destination": id_destination,
                },
                {
                    "name_field": f"uuid_base_{name}",
                    "fr_label": f"UUID {name}",
                    "type_field": "text",
                    "type_column": "uuid",
                    "mandatory": True,
                    "autogenerated": False,
                    "display": True,
                    "source_field": f"src_uuid_base_{name}",
                    "dest_field": f"uuid_base_{name}",
                    "multi": False,
                    "id_destination": id_destination,
                },
            ]
    ...
    if "observation" in entities:
        protocol_data["observation"]["generic"].extend(
            [
                {
                    "name_field": f"uuid_observation",
                    "fr_label": f"UUID observation",
                    "type_field": "text",
                    "type_column": "uuid",
                    "mandatory": False,
                    "autogenerated": False,
                    "display": True,
                    "source_field": f"src_uuid_observation",
                    "dest_field": f"uuid_observation",
                    "multi": False,
                    "id_destination": id_destination,
                },
            ]
