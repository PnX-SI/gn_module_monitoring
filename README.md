...
Suite à la mise à jour du module Monitoring, les liens symboliques peuvent être rompus. Dans ce cas, les images n'apparaissent pas sur la page du module et les sous-modules ne se chargent pas lorsque l'utilisateur clique dessus. De ce fait, il faut recréer da les liens symboliques dans le dossier `geonature/backend/media/monitorings` comme lors de l'installation d'un sous-module.
