...
- Création gestionnaire des types de sites
...
- Si vous avez des modules installés, les vues synthèses et exports ne seront pas compatibles et bloqueront la migration. Il faut les supprimer en amont et les recréer en tenant compte du nouveau modèle de données.
